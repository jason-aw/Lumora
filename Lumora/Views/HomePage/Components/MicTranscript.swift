...
class MicTranscript {
    ...
    func startListening() {
        ...
        recognitionTask = speechRecognizer.recognitionTask(with: transcriptRequest) { [weak self] result, error in
            guard let self else { return }
            
            if let result = result {
                // Publish curr speech/transcription
                Task { @MainActor in
...
//            self.chat.append(ChatLog(text: reply, isUser: false))
//        }
